...
class CreatePurchaseOrderShipment(BaseModel):
    """
    CreatePurchaseOrderShipment
    """ # noqa: E501
    carrier_shipment_no: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=64)]] = Field(default=None, description="The field is also known as PRO number is a unique number assigned by the carrier.  It is used to identify and track the shipment that goes out for delivery.  This field is mandatory for US, CA, MX shipment confirmations of Amazon Vendor", alias="CarrierShipmentNo")
    carrier_name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=64)]] = Field(default=None, description="Name of the carrier", alias="CarrierName")
    ...
    __properties: ClassVar[List[str]] = ["CarrierShipmentNo", "CarrierName", "MerchantShipmentNo", "ShipmentType", "ShippedDate", "EstimatedDeliveryDate", "SellingPartyId", "ShipToPartyId", "BillOfLadingNumber", "ShipmentWeightUnitOfMeasure", "ShipmentWeight", "ShipmentVolumeUnitOfMeasure", "ShipmentVolume", "Lines"]
