...
class MerchantGetReportStatusResponse(BaseModel):
    """
    MerchantGetReportStatusResponse
    """ # noqa: E501
    status: Optional[ReportStatus] = Field(default=None, alias="Status")
    resource_url: Optional[StrictStr] = Field(default=None, alias="ResourceUrl")
    __properties: ClassVar[List[str]] = ["Status", "ResourceUrl"]
