...
class CollectionOfIPurchaseOrderShipmentByFilter(BaseModel):
    """
    CollectionOfIPurchaseOrderShipmentByFilter
    """ # noqa: E501
    content: Optional[List[IPurchaseOrderShipmentByFilter]] = Field(default=None, alias="Content")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Content": [IPurchaseOrderShipmentByFilter.from_dict(_item) for _item in obj["Content"]] if obj.get("Content") is not None else None,
            "Count": obj.get("Count"),
