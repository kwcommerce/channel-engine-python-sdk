...
class SingleMerchantAcknowledgePurchaseOrderLinesRequest(BaseModel):
    """
    SingleMerchantAcknowledgePurchaseOrderLinesRequest
    """ # noqa: E501
    channel_id: Optional[StrictInt] = Field(default=None, alias="ChannelId")
    line_identifier_type: Optional[PurchaseOrderLineIdentifierType] = Field(default=None, alias="LineIdentifierType")
    identifier_type: Optional[PurchaseOrderIdentifierType] = Field(default=None, alias="IdentifierType")
    model: Optional[MerchantAcknowledgePurchaseOrder] = Field(default=None, alias="Model")
    __properties: ClassVar[List[str]] = ["ChannelId", "LineIdentifierType", "IdentifierType", "Model"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "LineIdentifierType": obj.get("LineIdentifierType"),
            "IdentifierType": obj.get("IdentifierType"),
            "Model": MerchantAcknowledgePurchaseOrder.from_dict(obj["Model"]) if obj.get("Model") is not None else None
        })
        return _obj
