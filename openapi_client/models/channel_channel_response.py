...
class ChannelChannelResponse(BaseModel):
    """
    ChannelChannelResponse
    """ # noqa: E501
    channel_id: Optional[StrictInt] = Field(default=None, description="The ID of the Channel.", alias="ChannelId")
    is_enabled: Optional[StrictBool] = Field(default=None, description="A boolean value indicating whether the Channel is enabled.", alias="IsEnabled")
    channel_name: Optional[StrictStr] = Field(default=None, description="The name of the Channel.", alias="ChannelName")
    reference: Optional[StrictStr] = Field(default=None, alias="Reference")
    __properties: ClassVar[List[str]] = ["ChannelId", "IsEnabled", "ChannelName", "Reference"]
