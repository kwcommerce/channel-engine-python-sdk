...
class SettlementCustomJsonMapper(BaseModel):
    """
    SettlementCustomJsonMapper
    """ # noqa: E501
    mapping: Optional[SettlementCustomJsonMapperMappings] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mapping": SettlementCustomJsonMapperMappings.from_dict(obj["mapping"]) if obj.get("mapping") is not None else None
        })
        return _obj
