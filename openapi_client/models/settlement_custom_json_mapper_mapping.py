...
class SettlementCustomJsonMapperMapping(BaseModel):
    """
    SettlementCustomJsonMapperMapping
    """ # noqa: E501
    active: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    sort_id: Optional[StrictInt] = Field(default=None, alias="sortId")
    __properties: ClassVar[List[str]] = ["active", "name", "sortId"]
