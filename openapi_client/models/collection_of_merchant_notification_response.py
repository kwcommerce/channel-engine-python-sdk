...
class CollectionOfMerchantNotificationResponse(BaseModel):
    """
    CollectionOfMerchantNotificationResponse
    """ # noqa: E501
    content: Optional[List[MerchantNotificationResponse]] = Field(default=None, alias="Content")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Content": [MerchantNotificationResponse.from_dict(_item) for _item in obj["Content"]] if obj.get("Content") is not None else None,
            "Count": obj.get("Count"),
