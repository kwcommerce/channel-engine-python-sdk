...
class MerchantProductAttributeGroupChannelInfoResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ChannelId", "ChannelName", "IsEnabled", "GlobalChannelId", "GlobalChannelName"]
