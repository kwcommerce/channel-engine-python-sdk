...
class MerchantShipmentPackageDimensionsRequest(BaseModel):
    """
    ...
    unit: Optional[PackageDimensionsUnit] = Field(default=None, alias="Unit")
    __properties: ClassVar[List[str]] = ["Height", "Width", "Length", "Unit"]
