...
class ProductMessage(BaseModel):
    ...
    key_reference: Optional[StrictStr] = Field(default=None, alias="KeyReference")
    ...
    __properties: ClassVar[List[str]] = ["Name", "Reference", "KeyReference", "Warnings", "Errors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if key_reference (nullable) is None
        # and model_fields_set contains the field
        if self.key_reference is None and "key_reference" in self.model_fields_set:
            _dict['KeyReference'] = None
