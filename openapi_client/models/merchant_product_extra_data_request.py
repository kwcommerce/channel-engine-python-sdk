...
class MerchantProductExtraDataRequest(BaseModel):
    """
    MerchantProductExtraDataRequest
    """ # noqa: E501
    merchant_product_no: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="MerchantProductNo")
    operations: List[ProductExtraDataRequest] = Field(alias="Operations")
    __properties: ClassVar[List[str]] = ["MerchantProductNo", "Operations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Operations": [ProductExtraDataRequest.from_dict(_item) for _item in obj["Operations"]] if obj.get("Operations") is not None else None
        })
        return _obj
