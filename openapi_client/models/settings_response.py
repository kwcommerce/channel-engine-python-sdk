...
class SettingsResponse(BaseModel):
    ...
    SettingsResponse
    """ # noqa: E501
    shipment: Optional[ShipmentSettingsResponse] = Field(default=None, alias="Shipment")
    advanced: Optional[AdvanceSettingsResponse] = Field(default=None, alias="Advanced")
    __properties: ClassVar[List[str]] = ["Shipment", "Advanced"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Shipment": ShipmentSettingsResponse.from_dict(obj["Shipment"]) if obj.get("Shipment") is not None else None,
            "Advanced": AdvanceSettingsResponse.from_dict(obj["Advanced"]) if obj.get("Advanced") is not None else None
        })
        return _obj
