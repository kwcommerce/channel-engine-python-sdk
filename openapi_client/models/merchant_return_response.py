...
class MerchantReturnResponse(BaseModel):
    """
    ...
    lines: Optional[List[MerchantReturnLineResponse]] = Field(default=None, alias="Lines")
    ...
    acknowledged_date: Optional[datetime] = Field(default=None, description="Date of acknowledgement", alias="AcknowledgedDate")
    ...
    __properties: ClassVar[List[str]] = ["MerchantOrderNo", "ChannelOrderNo", "ChannelId", "GlobalChannelId", "GlobalChannelName", "Lines", "CreatedAt", "UpdatedAt", "MerchantReturnNo", "ChannelReturnNo", "Status", "AcknowledgedDate", "Id", "Reason", "CustomerComment", "MerchantComment", "RefundInclVat", "RefundExclVat", "ReturnDate", "ExtraData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Lines": [MerchantReturnLineResponse.from_dict(_item) for _item in obj["Lines"]] if obj.get("Lines") is not None else None,
