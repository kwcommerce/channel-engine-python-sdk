...
class MerchantReturnLineUpdateRequest(BaseModel):
    """
    ...
    accepted_quantity: Annotated[int, Field(strict=True, ge=0)] = Field(description="The amount of items that have been accepted.", alias="AcceptedQuantity")
    rejected_quantity: Annotated[int, Field(strict=True, ge=0)] = Field(description="The amount of items that have been rejected.", alias="RejectedQuantity")
    __properties: ClassVar[List[str]] = ["MerchantProductNo", "AcceptedQuantity", "RejectedQuantity"]
