...
class SingleOfProductCreationResult(BaseModel):
    """
    SingleOfProductCreationResult
    """ # noqa: E501
    content: Optional[ProductCreationResult] = Field(default=None, alias="Content")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Content": ProductCreationResult.from_dict(obj["Content"]) if obj.get("Content") is not None else None,
