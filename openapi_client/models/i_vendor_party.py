...
class IVendorParty(BaseModel):
    """
    IVendorParty
    """ # noqa: E501
    party_id: Optional[StrictStr] = Field(default=None, alias="PartyId")
    ...
    __properties: ClassVar[List[str]] = ["PartyId", "TaxRegistrationType", "TaxRegistrationNo", "Name", "AddressLine1", "AddressLine2", "AddressLine3", "City", "County", "District", "StateOrRegion", "PostalCode", "CountryCode", "Phone"]
