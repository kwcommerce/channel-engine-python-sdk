...
class WebhookApi:
    ...
    def webhooks_create(
        self,
        merchant_webhook_request: Optional[MerchantWebhookRequest] = None,
        ...
        :param merchant_webhook_request:
        :type merchant_webhook_request: MerchantWebhookRequest
        ...
        _param = self._webhooks_create_serialize(
            merchant_webhook_request=merchant_webhook_request,
    ...
    def _webhooks_create_serialize(
        ...
        if merchant_webhook_request is not None:
            _body_params = merchant_webhook_request
    ...
    def webhooks_delete(
        self,
        webhook_name: Annotated[StrictStr, Field(description="The unique name of a webhook you want to delete.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param webhook_name: The unique name of a webhook you want to delete. (required)
    ...
    def _webhooks_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v2/webhooks/{webhookName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def webhooks_get_all(
        ...
        _param = self._webhooks_get_all_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CollectionOfMerchantWebhookResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def webhooks_get_all_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CollectionOfMerchantWebhookResponse]:
        """Gets webhooks
    ...
    @validate_call
    def webhooks_get_all_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _webhooks_get_all_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
