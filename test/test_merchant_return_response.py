...
class TestMerchantReturnResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MerchantReturnResponse:
        """Test MerchantReturnResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantReturnResponse`
        """
        model = MerchantReturnResponse()
        if include_optional:
            return MerchantReturnResponse(
                merchant_order_no = '',
                channel_order_no = '',
                channel_id = 56,
