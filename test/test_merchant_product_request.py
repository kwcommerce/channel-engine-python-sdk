...
class TestMerchantProductRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MerchantProductRequest:
        """Test MerchantProductRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantProductRequest`
        """
        model = MerchantProductRequest()
        if include_optional:
