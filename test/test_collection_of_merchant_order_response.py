...
class TestCollectionOfMerchantOrderResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CollectionOfMerchantOrderResponse:
        """Test CollectionOfMerchantOrderResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionOfMerchantOrderResponse`
        """
        model = CollectionOfMerchantOrderResponse()
        if include_optional:
            return CollectionOfMerchantOrderResponse(
                content = [
                    openapi_client.models.merchant_order_response.MerchantOrderResponse(
                        id = 56, 
                        channel_name = '', 
                        channel_id = 56, 
                        global_channel_name = '', 
