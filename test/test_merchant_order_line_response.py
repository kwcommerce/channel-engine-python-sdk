...
class TestMerchantOrderLineResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MerchantOrderLineResponse:
        """Test MerchantOrderLineResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantOrderLineResponse`
        """
        model = MerchantOrderLineResponse()
        if include_optional:
            return MerchantOrderLineResponse(
                id = 56,
