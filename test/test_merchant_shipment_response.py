...
class TestMerchantShipmentResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MerchantShipmentResponse:
        """Test MerchantShipmentResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantShipmentResponse`
        """
        model = MerchantShipmentResponse()
        if include_optional:
            return MerchantShipmentResponse(
