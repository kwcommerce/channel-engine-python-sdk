...
class TestMerchantSingleOrderReturnLineResponse(unittest.TestCase):
    """MerchantSingleOrderReturnLineResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MerchantSingleOrderReturnLineResponse:
        """Test MerchantSingleOrderReturnLineResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantSingleOrderReturnLineResponse`
        """
        model = MerchantSingleOrderReturnLineResponse()
        if include_optional:
            return MerchantSingleOrderReturnLineResponse(
                merchant_product_no = '',
    ...
    def testMerchantSingleOrderReturnLineResponse(self):
        """Test MerchantSingleOrderReturnLineResponse"""
