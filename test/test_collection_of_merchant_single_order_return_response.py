...
class TestCollectionOfMerchantSingleOrderReturnResponse(unittest.TestCase):
    """CollectionOfMerchantSingleOrderReturnResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionOfMerchantSingleOrderReturnResponse:
        """Test CollectionOfMerchantSingleOrderReturnResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionOfMerchantSingleOrderReturnResponse`
        """
        model = CollectionOfMerchantSingleOrderReturnResponse()
        if include_optional:
            return CollectionOfMerchantSingleOrderReturnResponse(
                content = [
                    openapi_client.models.merchant_single_order_return_response.MerchantSingleOrderReturnResponse(
                        merchant_order_no = '', 
                        lines = [
    ...
    def testCollectionOfMerchantSingleOrderReturnResponse(self):
        """Test CollectionOfMerchantSingleOrderReturnResponse"""
