...
class TestCreatePurchaseOrderShipment(unittest.TestCase):
    """CreatePurchaseOrderShipment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePurchaseOrderShipment:
        """Test CreatePurchaseOrderShipment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePurchaseOrderShipment`
        """
        model = CreatePurchaseOrderShipment()
        if include_optional:
            return CreatePurchaseOrderShipment(
                carrier_shipment_no = '',
                carrier_name = '',
    ...
    def testCreatePurchaseOrderShipment(self):
        """Test CreatePurchaseOrderShipment"""
