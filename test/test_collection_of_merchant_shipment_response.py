...
class TestCollectionOfMerchantShipmentResponse(unittest.TestCase):
    """CollectionOfMerchantShipmentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionOfMerchantShipmentResponse:
        """Test CollectionOfMerchantShipmentResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionOfMerchantShipmentResponse`
        """
        model = CollectionOfMerchantShipmentResponse()
        if include_optional:
            return CollectionOfMerchantShipmentResponse(
                content = [
                    openapi_client.models.merchant_shipment_response.MerchantShipmentResponse(
                        merchant_shipment_no = '0', 
                        merchant_order_no = '', 
                        channel_shipment_no = '', 
                        channel_order_no = '', 
                        channel_id = 56, 
                        ...
                        lines = [
                            openapi_client.models.merchant_shipment_line_response.MerchantShipmentLineResponse(
    ...
    def testCollectionOfMerchantShipmentResponse(self):
        """Test CollectionOfMerchantShipmentResponse"""
