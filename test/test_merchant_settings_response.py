...
class TestMerchantSettingsResponse(unittest.TestCase):
    """MerchantSettingsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MerchantSettingsResponse:
        """Test MerchantSettingsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantSettingsResponse`
        """
        model = MerchantSettingsResponse()
        if include_optional:
    ...
    def testMerchantSettingsResponse(self):
        """Test MerchantSettingsResponse"""
