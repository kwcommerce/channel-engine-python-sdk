...
class TestCollectionOfIPurchaseOrderByFilter(unittest.TestCase):
    """CollectionOfIPurchaseOrderByFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionOfIPurchaseOrderByFilter:
        """Test CollectionOfIPurchaseOrderByFilter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionOfIPurchaseOrderByFilter`
        """
        model = CollectionOfIPurchaseOrderByFilter()
        if include_optional:
            return CollectionOfIPurchaseOrderByFilter(
                content = [
                    openapi_client.models.i_purchase_order_by_filter.IPurchaseOrderByFilter(
                        id = 56, 
                        channel_id = 56, 
                        channel_name = '', 
                        global_channel_name = '', 
    ...
    def testCollectionOfIPurchaseOrderByFilter(self):
        """Test CollectionOfIPurchaseOrderByFilter"""
